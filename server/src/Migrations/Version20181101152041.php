 ...
 */
final class Version20181101152041 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE militants_groups (militant_id INT NOT NULL, group_id INT NOT NULL, INDEX IDX_A528DA222816464B (militant_id), INDEX IDX_A528DA22FE54D947 (group_id), PRIMARY KEY(militant_id, group_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE $militants_groups (militant_id INT NOT NULL, group_id INT NOT NULL, INDEX IDX_DDD775FF2816464B (militant_id), INDEX IDX_DDD775FFFE54D947 (group_id), PRIMARY KEY(militant_id, group_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
