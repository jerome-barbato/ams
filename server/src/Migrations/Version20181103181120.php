 ...
 */
final class Version20181103181120 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE place ADD gid VARCHAR(50) NOT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_741D53CD4C397118 ON place (gid)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_741D53CD4C397118 ON place');
        $this->addSql('ALTER TABLE place DROP gid');
    }
}
